...
```Groovy
implementation 'com.google.cloud:google-iam-admin:3.38.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-iam-admin" % "3.38.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-iam-admin/3.36.0
