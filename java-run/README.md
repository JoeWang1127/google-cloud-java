...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-run" % "0.43.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-run/0.41.0
