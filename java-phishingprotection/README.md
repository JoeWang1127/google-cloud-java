...
```Groovy
implementation 'com.google.cloud:google-cloud-phishingprotection:0.74.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-phishingprotection" % "0.74.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-phishingprotection/0.72.0
