...
```Groovy
implementation 'com.google.maps:google-maps-mapsplatformdatasets:0.32.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.maps" % "google-maps-mapsplatformdatasets" % "0.32.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.maps/google-maps-mapsplatformdatasets/0.30.0
